...
public partial class HistoryMainPageFriendshipSideBarPendingFriendsItemViewModel : BaseMainPageFriendshipSideBarItemViewModel, IRecipient<FriendshipChangedMessage>
{
    private ObservableCollection<BaseFriendshipViewModel> _items;

    public HistoryMainPageFriendshipSideBarPendingFriendsItemViewModel(MainPageViewModel baseViewModel) : base(baseViewModel)
    {
