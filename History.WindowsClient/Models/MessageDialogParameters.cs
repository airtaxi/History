...
public sealed class MessageDialogParameters(string title, string description, string primaryButtonText = null, string secondaryButtonText = null, string cancelButtonText = null)
{
