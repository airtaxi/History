...
type CommentContent = { $type: string; Text?: string; UserId?: string; Url?: string; FileName?: string; };

const generateContentsFromText = (): Array<CommentContent> => {
