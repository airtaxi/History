...
const props = defineProps<{
  show: boolean;
  users: Array<{ user: UserResponseDto; postId: string; isRepost: boolean; sharedAt: string; }>;
  title: string;
}>();

const emit = defineEmits(['close']); // eslint-disable-line @typescript-eslint/no-unused-vars
...
const loadProfileImages = async () => {
  ...
  props.users.forEach((item: { user: UserResponseDto; [key: string]: any; }) => {
