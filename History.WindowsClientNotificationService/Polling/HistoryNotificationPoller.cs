...
public sealed class HistoryNotificationPoller(NotificationStateStore stateStore, ToastPublisher toastPublisher, FileLogger logger)
{
    ...
    public async Task PollOnceAsync()
    {
        ...
        foreach (var notification in newNotifications) toastPublisher.Show(notification.Title, notification.Body, notification.ImageUrl, notification.Data);
