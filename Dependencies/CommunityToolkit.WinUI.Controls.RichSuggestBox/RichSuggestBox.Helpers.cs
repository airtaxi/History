...
public partial class RichSuggestBox2
{
    ...
    private static bool IsElementInsideWindow(FrameworkElement element, double offsetX = 0, double offsetY = 0)
    {
        ...
        var windowBounds = IsXamlRootAvailable && element.XamlRoot != null
...
#else
    internal static bool IsXamlRootAvailable { get; } = Windows.Foundation.Metadata.ApiInformation.IsPropertyPresent("Microsoft.UI.Xaml.UIElement", "XamlRoot");
#endif
}
